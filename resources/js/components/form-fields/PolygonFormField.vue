  ...
  <div class="map-container">
    ...
    >
      ...
      <ol-vector-layer :styles="vectorStyle">
        ...
        <ol-style>
          <ol-style-stroke
            :color="field.style.strokeColor"
            :width="field.style.strokeWidth"
          />
...
export default {
  ...
  expose: ["initCenter", "initZones", "clearZones", "capture", "isDirty"],
  methods: {
    initCenter() {
      let value = [];
      ...
      if (value.length) {
        const coordinates = [value[0].map((v) => fromLonLat([v[0], v[1]]))];
